+++
title = 'Node.js 速览笔记'
date = 2024-07-07T02:55:00+08:00
draft = false
toc = true
+++
...
![image-20220209152247426](nodejs速览笔记.assets/image-20220209152247426.png)
...
![image-20220210095903409](nodejs速览笔记.assets/image-20220210095903409.png)

##### 3.  模块、包、commonJS

![image-20220210100015768](nodejs速览笔记.assets/image-20220210100015768.png)

###### 02 CommonJS规范

<img src="nodejs速览笔记.assets/image-20220210101652166.png" alt="image-20220210101652166" style="zoom: 67%;" />

<img src="nodejs速览笔记.assets/image-20220210101720533.png" alt="image-20220210101720533" style="zoom: 67%;" />
...
> ![image-20220210114017616](nodejs速览笔记.assets/image-20220210114017616.png)
...
<img src="nodejs速览笔记.assets/image-20220213211406894.png" alt="image-20220213211406894" style="zoom:67%;" />

<img src="nodejs速览笔记.assets/image-20220213211423142.png" alt="image-20220213211423142" style="zoom:67%;" />
...
![image-20220407085931744](nodejs速览笔记.assets/image-20220407085931744.png)
...
<img src="nodejs速览笔记.assets/image-20220407105916114.png" alt="image-20220407105916114" style="zoom:50%;" />
...
<img src="nodejs速览笔记.assets/image-20220411103139587.png" alt="image-20220411103139587" style="zoom: 50%;float:left;" />
...
<img src="nodejs速览笔记.assets/image-20220411104609389.png" alt="image-20220411104609389" style="zoom:50%;float:left" />
...
<img src="nodejs速览笔记.assets/image-20220411104652068.png" alt="image-20220411104652068" style="zoom:50%;float:left" />

#### 三、MongoDB

##### 1.关系型与非关系型数据库

<img src="nodejs速览笔记.assets/image-20220413085332378.png" alt="image-20220413085332378" style="zoom:67%;float:left" />

<img src="nodejs速览笔记.assets/image-20220413090707891.png" alt="image-20220413090707891" style="zoom: 67%;float:left;" />

![image-20220413090406721](nodejs速览笔记.assets/image-20220413090406721.png)



![image-20220413090614205](nodejs速览笔记.assets/image-20220413090614205.png)
...
<img src="nodejs速览笔记.assets/image-20220413090814836.png" alt="image-20220413090814836" style="zoom:50%;float:left;" />
...
<img src="nodejs速览笔记.assets/image-20220413090916971.png" alt="image-20220413090916971" style="zoom:50%;float:left" />

##### 5.可视化工具进行增删改查

Robomongo Robo3T adminMongo

![image-20220413091031852](nodejs速览笔记.assets/image-20220413091031852.png)
...
<img src="nodejs速览笔记.assets/image-20220414094020921.png" alt="image-20220414094020921" style="zoom: 67%; float: left;" />

<img src="nodejs速览笔记.assets/image-20220414094043782.png" alt="image-20220414094043782" style="zoom: 67%;float:left" />

##### 2.业务分层

![image-20220414094653807](nodejs速览笔记.assets/image-20220414094653807.png)

#### 五、登录鉴权

##### 1. Cookie&Session

「HTTP 无状态」**我们知道，HTTP 是无状态的。也就是说，HTTP 请求方和响应方间无法维护状态，都是一次性的，它不知道前后的请求都发生了什么。但有的场景下，我们需要维护状态。最典型的，一个用户登陆微博，发布、关注、评论，都应是在登录后的用户状态下的。**「标记」那解决办法是什么呢？![image-20220414095345868](nodejs速览笔记.assets/image-20220414095345868.png)
...
![image-20220415082822828](nodejs速览笔记.assets/image-20220415082822828.png)

我为什么要保存这可恶的session呢， 只让每个客户端去保存该多好？

![image-20220415083015066](nodejs速览笔记.assets/image-20220415083015066.png)
...
## ![image-20220415085343339](nodejs速览笔记.assets/image-20220415085343339.png)
...
<img src="nodejs速览笔记.assets/image-20220417075653414.png" alt="image-20220417075653414" style="zoom:50%;" />
...
![image-20220417092053231](nodejs速览笔记.assets/image-20220417092053231.png)
...
<img src="nodejs速览笔记.assets/image-20220417083817823.png" alt="image-20220417083817823" style="zoom:50%;float:left;" />

   ![image-20220417085913567](nodejs速览笔记.assets/image-20220417085913567.png)
...
![image-20220417102845079](nodejs速览笔记.assets/image-20220417102845079.png)
...
![image-20220420083146539](nodejs速览笔记.assets/image-20220420083146539.png)
...
![image-20220420092527846](nodejs速览笔记.assets/image-20220420092527846.png)
...
![image-20220420090841742](nodejs速览笔记.assets/image-20220420090841742.png)
...
<img src="nodejs速览笔记.assets/image-20220421084242097.png" alt="image-20220421084242097" style="zoom:50%;" />
...
![image-20220505113605440](nodejs速览笔记.assets/image-20220505113605440.png)
